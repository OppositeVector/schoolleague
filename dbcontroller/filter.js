...
exports.Filter = function(schools, param1, param2, param3, param4, param5) {

	params = [];
	if((param1 != null) && (param1 > -1)) {
		params.push(criteria.find(function(ele){ return ele.id == param1; }));
	}
	if((param2 != null) && (param2 > -1)) {
		params.push(criteria.find(function(ele){ return ele.id == param2; }));
	}
	if((param3 != null) && (param3 > -1)) {
		params.push(criteria.find(function(ele){ return ele.id == param3; }));
	}
	if((param4 != null) && (param4 > -1)) {
		params.push(criteria.find(function(ele){ return ele.id == param4; }));
	}
	if((param5 != null) && (param5 > -1)) {
		params.push(criteria.find(function(ele){ return ele.id == param5; }));
	}
